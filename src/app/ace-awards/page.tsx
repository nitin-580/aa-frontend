...
export default function AceAwardsPage() {
  return (
    <div className="bg-[#F4F6F9] min-h-screen text-[#0F1E36]">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold tracking-tight mb-3">ACE Awards</h1>
          <p className="text-lg text-gray-500 max-w-2xl mx-auto font-quicksand">
            Celebrating alumni who exemplify achievement, contribution and excellence.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12 mb-12 text-center relative overflow-hidden">
          ...
          <div className="max-w-xl mx-auto">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Excellence deserves a stage.</h2>
            <p className="text-gray-500 leading-relaxed font-quicksand">
              We&apos;re preparing the hall of achievements. Award categories, previous winners, and nomination portals will appear here.
            </p>
