    ...
    <div className="bg-[#F4F6F9] min-h-screen text-[#0F1E36]">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold tracking-tight mb-3">Supporting the Next Generation</h1>
          <p className="text-lg text-gray-500 max-w-2xl mx-auto font-quicksand">
            Explore scholarship opportunities and initiatives supporting SVNIT students and the wider community.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12 mb-12 text-center relative overflow-hidden">
          ...
          <div className="max-w-xl mx-auto">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mb-4">The next opportunity might change a life.</h2>
            <p className="text-gray-500 leading-relaxed font-quicksand">
              We&apos;re preparing this space for scholarship opportunities and initiatives across the SVNIT community.
            </p>
